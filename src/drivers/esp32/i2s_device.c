...
// TODO: Handle not enabled, perhaps have a return value here?
static void esp32_i2s_init(uint32_t sample_rate, int bits_per_sample, int channels)
{
    ...
    i2s_std_slot_config_t my_slot_cfg = I2S_STD_PHILIPS_SLOT_DEFAULT_CONFIG(I2S_DATA_BIT_WIDTH_16BIT, I2S_SLOT_MODE_STEREO);
    // my_slot_cfg.bit_shift = false;
...
static void esp32_i2s_write(int16_t *data_buf, size_t buf_len)
{
    ...
    // TODO: Check is the channel is enabled before writing?
